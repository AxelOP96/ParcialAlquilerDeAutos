...
public class TestGaraje {
    ...
    public void queNoSePuedaRegistrarDosGarajesConLaMismaDireccion() {
        ...
        Garaje garaje2 = new Garaje(2, "Av. Siempreviva 742", 7, new ArrayList<>());
    ...
    public void queSePuedaAgregarYQuitarUnAuto() {
        Garaje garaje = new Garaje(1, "Av. Siempreviva 742", 5, new ArrayList<>());
        Auto auto = new Auto("AAA123", "Fiat", "Uno", 0, 1500.0, garaje, 150, new ArrayList<Alquiler>());
    ...
    public void queSePuedaBuscarUnAutoPorPatente() {
        Garaje garaje = new Garaje(1, "Av. Siempreviva 742", 5, new ArrayList<>());
        Auto auto1 = new Auto("AAA123", "Fiat", "Uno", 0, 1500.0, garaje, 150, new ArrayList<Alquiler>());
        Auto auto2 = new Auto("BBB456", "Renault", "Kwid", 0, 2000.0, garaje, 500, new ArrayList<Alquiler>());
    ...
    public void queElGarajeTengaEspaciosDisponibles() {
        Garaje garaje = new Garaje(1, "Av. Siempreviva 742", 5, new ArrayList<>());
        Auto auto1 = new Auto("AAA123", "Fiat", "Uno", 0, 1500.0, garaje, 500, new ArrayList<Alquiler>());
        garaje.agregarAuto(auto1);
    ...
    public void queElGarajeNoTengaEspaciosDisponibles() {
        ...
        Auto auto1 = new Auto("AAA123", "Fiat", "Uno", 0, 1500.0, garaje, 500, new ArrayList<Alquiler>());
        Auto auto2 = new Auto("BBB456", "Renault", "Kwid", 0, 2000.0, garaje, 300, new ArrayList<Alquiler>());
        garaje.agregarAuto(auto1);
        garaje.agregarAuto(auto2);
    ...
    public void testAgregarAuto() {
        ...
        Auto auto1 = new Auto("ABC123", "Toyota", "Corolla", 0, 2000.0, garaje, 150, new ArrayList<Alquiler>());
        Auto auto2 = new Auto("DEF456", "Ford", "Focus", 0, 1500.0, garaje, 150, new ArrayList<Alquiler>());
        garaje.agregarAuto(auto1);
        garaje.agregarAuto(auto2);
    ...
    public void testQuitarAuto() {
        Garaje garaje = new Garaje(1, "Calle 123", 5, new ArrayList<>());
        Auto auto1 = new Auto("ABC123", "Toyota", "Corolla", 0, 2000.0, garaje, 200, new ArrayList<Alquiler>());
        Auto auto2 = new Auto("DEF456", "Ford", "Focus", 0, 1500.0, garaje, 200, new ArrayList<Alquiler>());
        garaje.agregarAuto(auto1);
        garaje.agregarAuto(auto2);
    ...
    public void testBuscarAuto() {
        Garaje garaje = new Garaje(1, "Calle 123", 5, new ArrayList<>());
        Auto auto1 = new Auto("ABC123", "Toyota", "Corolla", 0, 2000.0, garaje, 150, new ArrayList<Alquiler>());
        Auto auto2 = new Auto("DEF456", "Ford", "Focus", 0, 1500.0, garaje, 300, new ArrayList<Alquiler>());
        garaje.agregarAuto(auto1);
        garaje.agregarAuto(auto2);
