...
public class TestAutos {
	...
	public void queSePuedaEliminarUnAuto() {
	    ...
	    Auto auto = new Auto("ABC123", "Toyota", "Corolla", 2019, 2000.0, garaje, new ArrayList<Alquiler>());
	...
	public void queSePuedaCambiarDeGarajeUnAuto() {
	    ...
	    Auto auto = new Auto("ABC123", "Toyota", "Corolla", 2019, 2000.0, garaje1, new ArrayList<Alquiler>());
	    agencia.registrarAuto(auto);
	...
	public void queSePuedaCambiarDeAuto() {
	    ...
	    Garaje garaje = new Garaje(1, "Av. Siempreviva 742", 5, new ArrayList<>());
	    agencia.agregarGaraje(garaje);
	    Auto auto1 = new Auto("ABC123", "Toyota", "Corolla", 2019, 2000.0, garaje, new ArrayList<Alquiler>());
	    Auto auto2 = new Auto("DEF456", "Chevrolet", "Cruze", 2020, 2500.0, garaje, new ArrayList<Alquiler>());
	...
	public void queNoSePuedaAgregarAutosConLaMismaPatente() {
	   ...
	   agencia.agregarGaraje(garaje);
	    Auto auto1 = new Auto("ABC123", "Toyota", "Corolla", 2019, 2000.0, garaje, new ArrayList<Alquiler>());
	    Auto auto2 = new Auto("ABC123", "Chevrolet", "Cruze", 2020, 2500.0, garaje, new ArrayList<Alquiler>());
	   agencia.registrarAuto(auto1);
	...
	public void queSePuedaBuscarUnAutoPorMarca() {
	    ...
	    Garaje garaje1 = new Garaje(1, "Av. Siempreviva 742", 5, new ArrayList<>());
	    agencia.agregarGaraje(garaje1);
	    Auto auto1 = new Auto("ABC123", "Chevrolet", "Onix", 2021, 1000.0, garaje1, new ArrayList<Alquiler>());
	    Auto auto2 = new Auto("DEF456", "Ford", "Fiesta", 2020, 800.0, garaje1, new ArrayList<Alquiler>());
	    Auto auto3 = new Auto("GHI789", "Chevrolet", "Cruze", 2022, 1200.0, garaje1, new ArrayList<Alquiler>());
	    agencia.registrarAuto(auto1);
	    agencia.registrarAuto(auto2);
	...
	public void queSePuedaMostrarLaCantidadDeAutosDeUnaMarcaDeAuto() {
	    Agencia agencia = new Agencia("MiAgencia", 203456789, new ArrayList<>());
	    Garaje garaje = new Garaje(1, "Av. Siempreviva 742", 5, new ArrayList<>());
	    Auto auto1 = new Auto("ABC123", "Ford", "Focus", 2015, 500.0, garaje, new ArrayList<Alquiler>());
	    Auto auto2 = new Auto("DEF456", "Ford", "Fiesta", 2016, 600.0, garaje, new ArrayList<Alquiler>());
	    Auto auto3 = new Auto("GHI789", "Chevrolet", "Corsa", 2017, 700.0, garaje, new ArrayList<Alquiler>());
	    agencia.agregarGaraje(garaje);
	...
	public void queSePuedanOrdenarLosAutosPorPrecio() {
	    ...
	    Auto auto1 = new Auto("ABC123", "Toyota", "Corolla", 2019, 2000.0, garaje, new ArrayList<Alquiler>());
	    Auto auto2 = new Auto("DEF456", "Chevrolet", "Cruze", 2020, 2500.0, garaje, new ArrayList<Alquiler>());
	    Auto auto3 = new Auto("GHI789", "Ford", "Fiesta", 2021, 1800.0, garaje, new ArrayList<Alquiler>());
	    garaje.agregarAuto(auto1);
	    garaje.agregarAuto(auto2);
	    garaje.agregarAuto(auto3);
	...
	public void queSePuedaMostrarLosAutosDisponiblesOrdenadosPorPrecio() {
	    ...
	    agencia.agregarGaraje(garaje2);
	    Auto auto1 = new Auto("ABC123", "Toyota", "Corolla", 2020, 2500.0, garaje1,  new ArrayList<Alquiler>());
	    agencia.registrarAuto(auto1);
	    Auto auto2 = new Auto("DEF456", "Honda", "Civic", 2021, 3000.0, garaje1, new ArrayList<Alquiler>());
	    agencia.registrarAuto(auto2);
	    Auto auto3 = new Auto("GHI789", "Toyota", "Yaris", 2019, 2000.0, garaje2,  new ArrayList<Alquiler>());
	    agencia.registrarAuto(auto3);
